...
{{-- Gunakan nomorUrut dari controller, bukan id database --}}
@section('header-title', 'Detail Pesanan #' . str_pad($nomorUrut, 3, '0', STR_PAD_LEFT))
...
<div class="space-y-5">
    ...
    <div class="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
        <div class="px-4 sm:px-5 py-4 border-b border-gray-200">
            <h2 class="text-base sm:text-lg font-bold text-gray-800">Daftar Menu</h2>
        </div>
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-4 py-3">
                            ...
                            <img src="{{ asset('uploads/menu/' . $detail->menu->gambar) }}"
                        ...
                        <td class="px-4 py-3">
                            <p class="text-sm font-semibold {{ $detail->menu ? 'text-gray-800' : 'text-gray-400' }}">
                        ...
                        <td class="px-4 py-3 text-right">
                            <span class="text-sm font-medium text-gray-700">Rp {{ number_format($detail->total, 0, ',', '.') }}</span>
                        </td>
                    </tr>
                    @empty
                    <tr>
        ...
        <div class="border-t border-gray-200 px-4 sm:px-5 py-4">
            <div class="flex items-center justify-between">
                ...
                <span class="text-lg font-bold text-gray-900">Rp {{ number_format($pesanan->total_harga, 0, ',', '.') }}</span>
            </div>
        </div>
    </div>
</div>
